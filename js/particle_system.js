...
particleSystem.prototype.initMessage = function () {
  ...
  this.ctx.fillText(
    String.fromCharCode(parseInt(this.str, 16)),
    this.width / 2,
    this.height - 50
  );
  this.ctx.closePath();
  ...
  for (var i = 0; i < this.mask.data.length; i += 3) {
    if (
      ...
      this.area.push([
        this.toPosX(i, this.mask.width + 50),
        this.toPosY(i, this.mask.width + 50),
      ]);
      //   console.log("ares", this.area);
    }
  }
